...
public class NewWorkOrderAdapter2 extends BaseQuickAdapter<WorkOrder.DataBean, BaseViewHolder> {
    public NewWorkOrderAdapter2(int layoutResId, @Nullable List<WorkOrder.DataBean> data) {
