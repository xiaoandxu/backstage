...
public interface VendorListContract  {
    interface Model extends BaseModel{
        ...
        Observable<GetUserInfoListForPlatformResult> GetUserInfoListForPlatform(RequestBody json);
    ...
    interface View extends BaseView{
        ...
        void GetUserInfoListForPlatform(GetUserInfoListForPlatformResult baseResult);
    ...
    abstract class Presenter extends BasePresenter<View,Model>{
        ...
        public abstract void GetUserInfoListForPlatform(RequestBody json);
