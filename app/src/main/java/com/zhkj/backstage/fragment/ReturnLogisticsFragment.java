...
/*返件物流*/
public class ReturnLogisticsFragment extends BaseLazyFragment<ExpressInfoPresenter, ExpressInfoModel> implements ExpressInfoContract.View, View.OnClickListener {
    ...
    public static ReturnLogisticsFragment newInstance(String param1, String param2) {
        ReturnLogisticsFragment fragment = new ReturnLogisticsFragment();
...
//        mImmersionBar.statusBarView(mView);
    ...
    protected int setLayoutId() {
        return R.layout.fragment_return_logistics;
    }
